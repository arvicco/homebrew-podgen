...
module PodgenCLI
  class ValidateCommand
    ...
    def run_single(name)
      ...
      # --- Image config ---
      check_image_config(config, passes, warnings, errors)
    ...
    def check_image_config(config, passes, warnings, errors)
      checked = false
      ...
      # Per-feed base_image paths (RSS sources with inline options)
